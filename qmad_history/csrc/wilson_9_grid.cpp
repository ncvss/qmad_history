...
void dw_templ_mtsgt_tmgsMht_loop (const double * U, const double * v,
...
#pragma omp parallel for
    for (int t1 = 0; t1 < vol/2; t1++){
        ...
        dw_templ_mtsgt_tmgsMht_loop<0,0,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,0,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,0,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,0,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<0,1,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,1,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,1,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,1,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<0,2,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,2,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,2,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<0,2,3>(U,v,hops,massf_reg,result,t1,vol);


        dw_templ_mtsgt_tmgsMht_loop<1,0,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,0,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,0,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,0,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<1,1,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,1,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,1,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,1,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<1,2,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,2,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,2,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<1,2,3>(U,v,hops,massf_reg,result,t1,vol);


        dw_templ_mtsgt_tmgsMht_loop<2,0,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,0,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,0,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,0,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<2,1,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,1,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,1,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,1,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<2,2,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,2,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,2,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<2,2,3>(U,v,hops,massf_reg,result,t1,vol);


        dw_templ_mtsgt_tmgsMht_loop<3,0,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,0,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,0,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,0,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<3,1,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,1,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,1,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,1,3>(U,v,hops,massf_reg,result,t1,vol);

        dw_templ_mtsgt_tmgsMht_loop<3,2,0>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,2,1>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,2,2>(U,v,hops,massf_reg,result,t1,vol);
        dw_templ_mtsgt_tmgsMht_loop<3,2,3>(U,v,hops,massf_reg,result,t1,vol);
