...
#pragma omp parallel for
    for (int t = 0; t < vol; t++){
        ...
        // loop over mu=0,1,2,3 s=0,2 and g=0,1,2 manually with template
        // the spin is vectorized, s=0,1 and s=2,3 are computed at the same time

        dw_templbound_mtsg_tmgsMhs_loop<0,0,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<0,1,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<0,2,0>(U,v,hops,bound,massf_reg,result,t,vol);

        dw_templbound_mtsg_tmgsMhs_loop<0,0,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<0,1,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<0,2,2>(U,v,hops,bound,massf_reg,result,t,vol);


        dw_templbound_mtsg_tmgsMhs_loop<1,0,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<1,1,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<1,2,0>(U,v,hops,bound,massf_reg,result,t,vol);

        dw_templbound_mtsg_tmgsMhs_loop<1,0,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<1,1,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<1,2,2>(U,v,hops,bound,massf_reg,result,t,vol);


        dw_templbound_mtsg_tmgsMhs_loop<2,0,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<2,1,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<2,2,0>(U,v,hops,bound,massf_reg,result,t,vol);

        dw_templbound_mtsg_tmgsMhs_loop<2,0,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<2,1,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<2,2,2>(U,v,hops,bound,massf_reg,result,t,vol);


        dw_templbound_mtsg_tmgsMhs_loop<3,0,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<3,1,0>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<3,2,0>(U,v,hops,bound,massf_reg,result,t,vol);

        dw_templbound_mtsg_tmgsMhs_loop<3,0,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<3,1,2>(U,v,hops,bound,massf_reg,result,t,vol);
        dw_templbound_mtsg_tmgsMhs_loop<3,2,2>(U,v,hops,bound,massf_reg,result,t,vol);
