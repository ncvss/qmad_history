...
#pragma omp parallel for
    for (int t = 0; t < vol; t++){
        ...
        dw_templ_mtsg_tmgsMhs_backw_loop<0,0,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<0,0,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<0,1,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<0,1,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<0,2,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<0,2,2>(U,v,hops,massf_reg,result,t,vol);


        dw_templ_mtsg_tmgsMhs_backw_loop<1,0,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<1,0,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<1,1,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<1,1,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<1,2,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<1,2,2>(U,v,hops,massf_reg,result,t,vol);


        dw_templ_mtsg_tmgsMhs_backw_loop<2,0,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<2,0,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<2,1,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<2,1,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<2,2,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<2,2,2>(U,v,hops,massf_reg,result,t,vol);


        dw_templ_mtsg_tmgsMhs_backw_loop<3,0,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<3,0,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<3,1,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<3,1,2>(U,v,hops,massf_reg,result,t,vol);

        dw_templ_mtsg_tmgsMhs_backw_loop<3,2,0>(U,v,hops,massf_reg,result,t,vol);
        dw_templ_mtsg_tmgsMhs_backw_loop<3,2,2>(U,v,hops,massf_reg,result,t,vol);
...
at::Tensor dw_templ_mtsg_tmgsMhs_backw (const at::Tensor& U_tensor, const at::Tensor& v_tensor,
                                  const at::Tensor& hops_tensor, double mass){
